...
call_user_func(function(){
    ...
    $EXT_CONFIG = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstance(\TYPO3\CMS\Core\Configuration\ExtensionConfiguration::class)
        ->get('shibboleth');
    ...
    \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addService(
        'shibboleth',
        'auth' /* sv type */,
        \TrustCnct\Shibboleth\ShibbolethAuthenticationService::class /* sv key */,
        [
            ...
            'os' => '',
            'exec' => '',
            'className' => \TrustCnct\Shibboleth\ShibbolethAuthenticationService::class,
        ]
    );
    ...
    \TYPO3\CMS\Extbase\Utility\ExtensionUtility::configurePlugin(
        ...
        'LoginLink',
        [
            \TrustCnct\Shibboleth\Controller\LoginLinkController::class => 'show'
        ]
    );
    ...
    $iconRegistry->registerIcon(
        ...
        ['source' => 'EXT:shibboleth/Resources/Public/Icons/user_plugin_loginlink.png']
    );
